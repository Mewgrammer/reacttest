    ...
    render() {
        return <div>
            ...
            <div style={{ textAlign: "center" }}>
                <button className="button" onClick={(event : any) => { this.slider.slickPrev(); }}>Previous</button>
                <button className="button" onClick={(event : any) => { this.slider.slickNext(); }}>Next</button>
                <button className="button" onClick={(event : any) => { this.slider.slickGoTo(1); }}>First</button>
            </div>
        </div>;
    }
}